  ...
  return (
    <div className="drag-region relative h-14 flex items-center justify-between px-5 bg-white dark:bg-zinc-800 border-b border-zinc-100 dark:border-zinc-700 shrink-0">
      ...
      <div className="flex items-center gap-3 no-drag shrink-0 z-10">
        <div className="w-8 h-8 rounded-xl bg-amber-600 dark:bg-amber-500 flex items-center justify-center">
          <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
            <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
          </svg>
        </div>
        <span className="text-base font-bold text-zinc-900 dark:text-zinc-100 tracking-tight">阅读器</span>
      </div>
      ...
      <div className="flex items-center gap-1.5 shrink-0 no-drag z-10">
        <button
          onClick={onImport}
          className="h-9 px-4 bg-amber-600 dark:bg-amber-500 text-white rounded-lg text-sm font-bold hover:bg-amber-700 dark:hover:bg-amber-600 active:scale-[0.97] transition-all inline-flex items-center justify-center gap-1.5"
        >
